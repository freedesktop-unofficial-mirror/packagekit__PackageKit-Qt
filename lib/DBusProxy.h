 ...
 * Command line was: dbusxml2cpp -c DBusProxy -p proxy.h /home/madcat/code/packagekit/src/pk-interface.xml org.freedesktop.PackageKit
 *
...
#ifndef PROXY_H_1205708853
#define PROXY_H_1205708853
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusReply<bool> GetAllowCancel(const QString &tid)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(tid);
    ...
    inline QDBusReply<void> GetDepends(const QString &tid, const QString &package_id, bool recursive)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(tid) << qVariantFromValue(package_id) << qVariantFromValue(recursive);
    ...
    inline QDBusReply<void> GetFiles(const QString &tid, const QString &package_id)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(tid) << qVariantFromValue(package_id);
    ...
    inline QDBusReply<void> GetRequires(const QString &tid, const QString &package_id, bool recursive)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(tid) << qVariantFromValue(package_id) << qVariantFromValue(recursive);
    ...
    inline QDBusReply<bool> IsCallerActive(const QString &tid)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(tid);
    ...
    inline QDBusReply<void> ServicePack(const QString &tid, const QString &location)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(tid) << qVariantFromValue(location);
        return callWithArgumentList(QDBus::Block, QLatin1String("ServicePack"), argumentList);
    }
...
Q_SIGNALS: // SIGNALS
    void AllowCancel(const QString &tid, bool allow_cancel);
    void CallerActiveChanged(const QString &tid, bool is_active);
    void Description(const QString &tid, const QString &package_id, const QString &license, const QString &group, const QString &detail, const QString &url, qulonglong size);
    void ErrorCode(const QString &tid, const QString &code, const QString &details);
    void Files(const QString &tid, const QString &package_id, const QString &file_list);
    void Finished(const QString &tid, const QString &status, uint runtime);
    void Locked(bool is_locked);
    void Message(const QString &tid, const QString &message, const QString &details);
    ...
    void StatusChanged(const QString &tid, const QString &status);
    ...
    void UpdateDetail(const QString &tid, const QString &package_id, const QString &updates, const QString &obsoletes, const QString &vendor_url, const QString &bugzilla_url, const QString &cve_url, const QString &restart, const QString &update_text);
