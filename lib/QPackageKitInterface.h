 ...
 * Command line was: dbusxml2cpp pk-interface.xml -p QPackageKitInterface.h -c QPackageKitInterface
 *
...
#ifndef QPACKAGEKITINTERFACE_H_1192635508
#define QPACKAGEKITINTERFACE_H_1192635508
...
public Q_SLOTS: // METHODS
	 ...
	 inline QDBusReply<uint> GetPercentage(const QString &tid)
	 {
		  QList<QVariant> argumentList;
		  argumentList << qVariantFromValue(tid);
		  return callWithArgumentList(QDBus::Block, QLatin1String("GetPercentage"), argumentList);
	 }
	 ...
	 inline QDBusReply<uint> GetSubPercentage(const QString &tid)
	 {
		  QList<QVariant> argumentList;
		  argumentList << qVariantFromValue(tid);
		  return callWithArgumentList(QDBus::Block, QLatin1String("GetSubPercentage"), argumentList);
	 }
	 ...
	 inline QDBusReply<void> Resolve(const QString &tid, const QString &package)
	 {
		  QList<QVariant> argumentList;
		  argumentList << qVariantFromValue(tid) << qVariantFromValue(package);
...
Q_SIGNALS: // SIGNALS
	 ...
	 void NoPercentageUpdates(const QString &tid);
	 void Package(const QString &tid, const QString &info, const QString &package_id, const QString &summary);
	 void PercentageChanged(const QString &tid, uint percentage);
	 ...
	 void SubPercentageChanged(const QString &tid, uint percentage);
