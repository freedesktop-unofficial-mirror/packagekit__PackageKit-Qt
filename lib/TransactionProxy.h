...
public Q_SLOTS: // METHODS
    ...
    inline QDBusReply<void> GetDepends(const QString &filter, const QString &package_id, bool recursive)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(filter) << qVariantFromValue(package_id) << qVariantFromValue(recursive);
    ...
    inline QDBusReply<void> GetRequires(const QString &filter, const QString &package_id, bool recursive)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(filter) << qVariantFromValue(package_id) << qVariantFromValue(recursive);
    ...
    inline QDBusReply<QString> GetRole(QString &package_id)
    {
        QList<QVariant> argumentList;
    ...
    inline QDBusReply<void> GetUpdateDetail(const QString &package_id)
    {
        QList<QVariant> argumentList;
        argumentList << qVariantFromValue(package_id);
    ...
    inline QDBusReply<void> Resolve(const QString &filter, const QString &package)
    {
        QList<QVariant> argumentList;
...
Q_SIGNALS: // SIGNALS
    ...
    void Finished(const QString &status, uint runtime);
